            ...
            if isSuccess{
                ...
                if response?.value(forKey: "code") as! NSNumber == 200 {
                    ...
                    for vidObject in vidObjMsg{
                        ...
                        let countryObj = vidObj.value(forKey: "Country") as! NSDictionary
...
//            vidCell.vidImg.image = imageURL
        ...
        if indexPath.row == 0 {
            if self.objArr[indexPath.row]["isSelected"] == "false" {
                ...
                cell.titleLbl.text = objArr[indexPath.row]["title"]
                cell.titleLbl.textColor = #colorLiteral(red: 0.7580462098, green: 0.8360280395, blue: 0.4221232533, alpha: 1)
            }
        }
        if indexPath.row == 1 {
            if self.objArr[indexPath.row]["isSelected"] == "false" {
