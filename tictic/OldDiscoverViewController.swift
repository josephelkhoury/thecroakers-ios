...
class OldDiscoverViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UISearchBarDelegate,ContentLoaderDataSource {
...
//            textfield.backgroundColor = UIColor.yellow
        ...
        self.refreshControl.addTarget(self, action: #selector(OldDiscoverViewController.refresh), for: UIControl.Event.valueChanged)
